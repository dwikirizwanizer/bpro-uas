import java.util.*;
public class MaintenanceBarang {
	...
	public static void admin (){
		...
		do {
			...
			System.out.println ("1. Maintenance Data Barang");
			...
			switch (Pil_Barang) {
						...
						int urutan=-1;
							...
							if (pilBarang == 4){
								for (int i=0; i<id.size(); i++){
									System.out.println (id.elementAt(i)+"\t"+namaBarang.elementAt(i)+"\t"+hargabeli.elementAt(i));
								}
							}
							...
							if (pilBarang == 5){
								...
								System.out.print ("Masukkan Nama Barang yang ingin dicari : ");
									...
									System.out.println (id.elementAt(urutann)+"\t"+namaBarang.elementAt(urutann)+"\t"+hargabeli.elementAt(urutann));
								}else {
				...
				case 3:
					...
					for (int k=0; k<2; k++) {
						System.out.println ("Total "+id.elementAt(k)+" : "+total.elementAt(k));
